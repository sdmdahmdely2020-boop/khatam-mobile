...
import '../../profile/screens/my_documents_screen.dart';
          ...
          children: [
            ...
            if (user != null && !user.isProfessor) ...[
              ...
              OutlinedButton.icon(
                ...
                icon: const Icon(Icons.menu_book_outlined, color: AppTheme.brandBlue),
                label: const Text('Mes documents', style: TextStyle(color: AppTheme.brandBlue)),
